...
import (
	...
	"gorm.io/gorm"
	commentV1 "message/api/comment/v1"
	favoriteV1 "message/api/favorite/v1"
	relationV1 "message/api/relation/v1"
	videov1 "message/api/video/v1"
...
func NewDB(conf *conf.Data) *gorm.DB {
	...
	if err != nil {
		log.Errorf("AutoMigrate model.Message failed: %v", err)
		return nil
	}
	log.Debugf("AutoMigrate model.Message success")
