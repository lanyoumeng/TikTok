...
func NewGRPCServer(pro *conf.Prometheus, c *conf.Server, Auth *conf.Auth, relation *service.RelationService, logger log.Logger) *grpc.Server {
...
func NewWhiteListMatcher() selector.MatchFunc {
	...
	whiteList["/relation.v1.RelationService/FollowCnt"] = struct{}{}
	whiteList["/relation.v1.RelationService/IsFollow"] = struct{}{}
